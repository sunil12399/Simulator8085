...
class Ui_MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.setMaximumSize(QtCore.QSize(16777215, 750))
        self.setStyleSheet(stylesheet)

        # self.lbl = QLabel(
        #     '<font color=Green size = 15><b><i>Simulator</i></b> for the<br><b style="margin-left: 20px"> 8085 </b></font>', self)
        # self.lbl.setWindowFlags(Qt.SplashScreen | Qt.FramelessWindowHint)
        ...
        self.fontSize.setEditable(False)
        self.fontSize.setMinimumContentsLength(3)
        flist = [8, 9, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 32, 36, 40, 44, 48]
        for i in flist:
        ...
        self.HomePage.setGeometry(QtCore.QRect(0, 90, 881, 701))
        self.HomePage.setFrameShape(QFrame.StyledPanel)
        self.HomePage.setFrameShadow(QFrame.Raised)
        # self.HomePage.setStyleSheet("background-color:red")
        ...
        self.WarningLabel.setGeometry(QtCore.QRect(20, 640, 851, 29))
        font = QFont()
        font.setFamily("Calibri")
